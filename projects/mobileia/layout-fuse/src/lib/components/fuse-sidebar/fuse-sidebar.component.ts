import { Component, OnInit, Input, HostBinding, ElementRef, Renderer2, ViewEncapsulation, ChangeDetectorRef, EventEmitter, Output, HostListener } from '@angular/core';
...
import { FuseMatchMediaService } from '../../services/fuse-match-media.service';
